...
CREATE TABLE "TB_APLICACIONES" (
  ...
  "PROVEEDOR_PERSONALIZADO" NUMBER(1,0) DEFAULT 0 NOT NULL,
  "TAMANO_PERSONALIZADO" NUMBER(1,0) DEFAULT 0 NOT NULL,
  "TAMANO_MAXIMO_DOCUMENTO" NUMBER(19),
  "TAMANO_MAXIMO_PETICION" NUMBER(19),
  "CANTIDAD_MAXIMA_DOCUMENTOS" NUMBER(19),
...
CREATE TABLE  "TB_USUARIOS" 
   ("ID_USUARIO" NUMBER NOT NULL, 
	...
	"DNI" VARCHAR(9) NULL,
	"FEC_ULTIMO_ACCESO" TIMESTAMP DEFAULT SYSDATE,
	 CONSTRAINT "TB_USUARIOS_PK" PRIMARY KEY ("ID_USUARIO"), 
	 CONSTRAINT "TB_USUARIOS_UK1" UNIQUE ("DNI"),
