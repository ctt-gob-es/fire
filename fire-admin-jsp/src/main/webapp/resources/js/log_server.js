 ...
 */
  $(document).ready(function(){
            ...
            /********************************************************/
            $.get("../LogServerService?act=0", function(data){
            	$("#data").html("");
            ...
            function printServersTable(JSONData){
            	...
            	for(var i = 0; i < JSONData.LogSrvs.length; i++){
            		...
            		htmlTableBody = htmlTableBody + '<a href="../LogServerService?act=1&id-srv=' +  JSONData.LogSrvs[i].id_servidor + '"><img src="../resources/img/servidor_icon.png"/></a>';   //Conectar
            		...
            		htmlTableBody = htmlTableBody + '<a href="../LogServerService?act=4&id-srv=' +  JSONData.LogSrvs[i].id_servidor + '"><img src="../resources/img/delete_icon.png" onclick="return confirmar(\'' + JSONData.LogSrvs[i].nombre + '\')"/></a>';	  			         			
