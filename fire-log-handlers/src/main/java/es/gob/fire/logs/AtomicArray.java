...
final class AtomicArray<T, V> {
     ...
     */
    public AtomicArray(final AtomicReferenceFieldUpdater<T, V[]> updater, final Class<V> componentType) {
        this.updater = updater;
        this.componentType = componentType;
        this.emptyArray = newInstance(componentType, 0);
    }
     ...
     */
    public void clear(final T instance) {
        this.updater.set(instance, this.emptyArray);
    }
     ...
     */
    public void set(final T instance, final V[] value) {
        this.updater.set(instance, value);
    }
     ...
     * @param value the new value
     */
    public V[] getAndSet(final T instance, final V[] value) {
     ...
     */
    public boolean addIfAbsent(final T instance, final V value, final boolean identity) {
        final AtomicReferenceFieldUpdater<T, V[]> updater = this.updater;
        for (;;) {
            final V[] oldVal = updater.get(instance);
            final int oldLen = oldVal.length;
    ...
    private static int insertionPoint(final int searchResult) {
        return searchResult > 0 ? searchResult : - (searchResult + 1);
    }

    @SuppressWarnings({ "unchecked" })
    private static <V> V[] newInstance(final Class<V> componentType, final int length) {
    ...
    public boolean compareAndSet(final T instance, final V[] expect, final V[] update) {
        return this.updater.compareAndSet(instance, expect, update);
    }
}
