...
public final class HttpSignProcess {
    ...
    private static void initializeProperties() throws ClientConfigFilesNotFoundException {
    	...
    	if (URL_BASE == null) {
    		throw new IllegalStateException(
				"No esta declarada la URL en la configuracion (propiedad 'signUrl')" //$NON-NLS-1$
			);
    	}
     ...
     * @param op Tipo de operaci&acute;n a realizar.
     * @param ft Formato de la operaci&oacute;n.
     * @param algth Algoritmo de firma.
     * @param prop Propiedades extra a a&ntilde;adir a la firma (puede ser <code>null</code>).
     * @param cert Certificado de usuario para realizar la firma.
     * @param data Datos a firmar.
     * @param td Informaci&oacute;n de la operaci&oacute;n trif&aacute;sica.
     * @param upgrade Formato al que queremos mejorar la firma (puede ser <code>null</code>).
    ...
    public static byte[] sign(final String appId,
    		                  ...
    		                  final HttpSignProcessConstants.SignatureUpgrade upgrade) throws IOException,
     ...
     * @param appId Identificador de la aplicaci&oacute;n que realiza la petici&oacute;n.
     * @param transactionId Identificador de la transacci&oacute;n.
     * @param op Tipo de operaci&oacute;n a realizar: "sign", "cosign" o "countersign".
     * @param ft Formato de la operaci&oacute;n.
     * @param algth Algoritmo de firma.
     * @param prop Propiedades extra de configuraci&oacute;n de la firma en Base64 URL SAFE (puede ser <code>null</code>).
     * @param cert Certificado de usuario en Base64 para realizar la firma.
     * @param dataB64 Datos a firmar en Base64.
     * @param tdB64 Datos de la operaci&oacute;n trif&aacute;sica en Base64.
     * @param upgrade Formato al que queremos mejorar la firma (puede ser <code>null</code>).
     * @return Firma realizada en servidor.
     * @throws HttpForbiddenException Cuando no se tiene acceso al servicio remoto.
     * @throws HttpNetworkException Si hay problemas en la llamada al servicio de red.
    ...
    public static byte[] sign(final String appId,
    						  ...
    						  final String tdB64,
    						  final String upgrade) throws HttpForbiddenException,
    													   HttpNetworkException,
    													   HttpOperationException,
    													   ClientConfigFilesNotFoundException {
    	initialize();
