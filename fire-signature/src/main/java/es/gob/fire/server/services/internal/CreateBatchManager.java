...
public class CreateBatchManager {
	...
	public static void createBatch(final HttpServletRequest request, final ApplicationInfo appInfo,
		...
		session.setAttribute(ServiceParams.SESSION_PARAM_LANGUAGE, language);        // Obtenemos el DocumentManager con el que recuperar los datos. Si no se especifico ninguno,
