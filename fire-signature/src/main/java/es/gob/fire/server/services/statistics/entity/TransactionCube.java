package es.gob.fire.server.services.statistics.entity;
...
public class TransactionCube {
	...
	public final static TransactionCube parse(final String registry) throws ParseException, SQLException, DBConnectionException {
