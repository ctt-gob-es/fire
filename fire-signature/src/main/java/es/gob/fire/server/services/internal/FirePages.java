...
/**
 * Clase con los nombres de las p&aacute;ginas del componente central.
 */
public class FirePages {

	 /** P&aacute;gina JSP "ChooseCertificate.jsp"*/
	public static final String PG_CHOOSE_CERTIFICATE="ChooseCertificate.jsp"; //$NON-NLS-1$
	 /** P&aacute;gina JSP "ChooseCertificateNoCerts.jsp"*/
	...
	public static final String PG_MINI_APPLET="MiniApplet.jsp"; //$NON-NLS-1$
	 /** P&aacute;gina JSP "SignatureErrorPage.jsp"*/
	public static final String PG_SIGNATURE_ERROR="SignatureErrorPage.jsp"; //$NON-NLS-1$
