...
public class CreateBatchService extends HttpServlet {
	...
	private static final Logger LOGGER = Logger.getLogger(CreateBatchService.class.getName());
	...
	protected void service(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			LOGGER.log(Level.SEVERE, "Ocurrio un error al crear un lote", e); //$NON-NLS-1$
