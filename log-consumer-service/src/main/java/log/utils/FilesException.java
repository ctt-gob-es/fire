 ...
 * distribuido. */
public final class FilesException extends Exception{
	 ...
	 */
	public FilesException(final String msg, final String filename) {
		super(msg);
		fileName = filename;
    }
	 ...
	 */
	public FilesException(final String msg, final String filename, final Throwable cause) {
		super(msg, cause);
		fileName = filename;
    }
	...
	public static String getFileName(){
		return FilesException.fileName;
	}
