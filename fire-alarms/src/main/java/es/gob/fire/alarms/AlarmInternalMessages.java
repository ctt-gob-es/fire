...
public final class AlarmInternalMessages {

    private static final String BUNDLE_NAME = "alarminternalmessages"; //$NON-NLS-1$

    private static ResourceBundle bundle = ResourceBundle.getBundle(BUNDLE_NAME);

    private AlarmInternalMessages() { /* No permitimos la instanciacion */ }
