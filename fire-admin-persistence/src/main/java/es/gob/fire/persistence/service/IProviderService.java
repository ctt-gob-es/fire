...
public interface IProviderService {
	 ...
	 * @return The provider.
	 */
	Provider findProviderById(String idProvider);
	 ...
	 * @param idProvider
	 */
	void moveProviderUp(int providerOrder, String idProvider);
	 ...
	 * @param idProvider
	 */
	void moveProviderDown(int providerOrder, String idProvider);
