...
public class CertificateRestController {
	...
	public String deleteCertificate(@RequestParam(FIELD_ID_CERTIFICATE) final Long idCertificate, @RequestParam(FIELD_ROW_INDEX_CERTIFICATE) final String index) {
		String result = index;
