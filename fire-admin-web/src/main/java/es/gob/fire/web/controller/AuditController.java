...
public class AuditController {
	...
	public String getAuditAdmin(final Model model) {
		...
		model.addAttribute("applicationsDropdown", this.auditTransactionService.getApplicationsDropdown());
	...
	public String viewAuditTransactionDetails(@RequestParam(FIELD_ID_AUDIT_TRANSACTION) final Integer idAuditTransaction, final Model model) {
		...
		final AuditTransactionDTO aduitTransactionForm = new AuditTransactionDTO(auditTransaction);
		...
		model.addAttribute("listAuditSignatures", this.auditTransactionService.getAllAuditSignaturesOfTransaction(auditTransaction));
